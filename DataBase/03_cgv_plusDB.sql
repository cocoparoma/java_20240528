...
insert into `cgv`.`schedule` values
...
# abc123 회원이 cgv 강남 1관 10:00에 상영하는 데드풀과 울버린 성인 2장을 예매하는 쿼리 (좌석 A1, A2)
# 가격 성인 : 14000, 청소년 10000, 조조 성인 12000, 조조 청소년 : 8000
...
insert into ticketing value
(null, 2, 0, 24000, 'abc123',  1);
