...
public class ObjectEx01 {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println("std1.equals(std2 : " + std1.equals(std3));
		System.out.println("std1.equals(std2 : " + std1.equals(std4));
...
class Student implements Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		// 비교대상이 null인 경우 > 비교할 수 없음
		if (obj == null)
			return false;
		// 내 클래스와 매개변수의 클래스가 다른 경우
		if (getClass() != obj.getClass())
			return false;
		// 내 클래스와 매개 변수의 클래스가 같은경우
		Student other = (Student) obj;// 다운 케스팅
