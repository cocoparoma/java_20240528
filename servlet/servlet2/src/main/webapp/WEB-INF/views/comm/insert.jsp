...
<div class="container mt-3">
  <h1>${co.co_name } 게시판 게시글 작성</h1>
	<form action="<c:url value="/comm/insert"/>" method="post">
    ...
    <div class="form-group">
  	...
  	<div class="d-flex justify-content-center mb-3">
	   	 <button type="submit" class="btn badge-success badge badge-pill" style="font-size: 30px;">작성</button>
    </div>
